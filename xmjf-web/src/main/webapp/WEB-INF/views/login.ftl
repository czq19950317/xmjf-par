            ...
            <div class="box-input">
                <div class="box-input-center">
                    <p class="login_input_wrap">
                        <input id="phone" placeholder="手机号" type="text" class="login-input" value="18661197721"/>
                    </p>
                    <p class="login_input_password">
                        <input id="password" placeholder="请输入密码" type="password" class="login-input" value="123456"/>
                    </p>
                </div>
